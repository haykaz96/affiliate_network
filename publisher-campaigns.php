...
$category_id = addslashes($_GET['category']);
...
<input type="text" placeholder="Offer name" name="search" id="search">
</div>
<?php
...
<select id="select_country" name="catagory">
...
<option value="<?php echo $row13['id']; ?>"><?php echo $row13['country_name']; ?></option>
<?php } ?>
</select>
</div>
<?php
